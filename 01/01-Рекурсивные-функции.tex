\documentclass[a4paper, 12pt, num=Г1, date = 19.12.2018]{listok}
\usepackage{bm}
\usepackage{scalerel}
\usepackage{tikz}
\usepackage{epigraph}
	...
	\begin{multicols}{2}
		...
		$
			case(x, y, z) = \left \{
				...
				\right .
		$
		\item $rm(x, y)$, $qt(x, y)$ --- остаток и частное от деления.
	\end{multicols}
	\end{enumerate}
\end{problem}
\begin{problem}
...
\begin{problem}[ (разбор случаев)]
	...
	\]
\end{problem}
\begin{problem}[ (совместная рекурсия)]
